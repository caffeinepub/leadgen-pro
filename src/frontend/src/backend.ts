...
export class Backend implements backendInterface {
    ...
    async getLeadsSortedByEmail(): Promise<Array<Lead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLeadsSortedByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async init(arg0: Init): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBookingUrl(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBookingUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
